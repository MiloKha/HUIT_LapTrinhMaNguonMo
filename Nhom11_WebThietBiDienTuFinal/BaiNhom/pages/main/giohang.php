...
<tr>
    <td colspan="8">
        <p style="float:left">Tổng tiền: <?php echo number_format($tongtien,0,',','.')?><sup>đ</sup> </p>
        <p style="float:right;margin-right:20px"><a href="pages/main/themgiohang.php?xoatatca=1">Xóa tất cả</a></p>
